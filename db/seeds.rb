...
t1.comments.create!(body: "Environment set up on macOS and Ubuntu. Windows requires WSL2.", user: bob)
t1.comments.create!(body: "README updated with setup instructions.", user: alice)
...
t2.comments.create!(body: "Generated with `rails generate authentication`. Login pages ready.", user: carol)
t2.comments.create!(body: "Password reset under testing on staging.", user: bob)
...
puts "✓ #{User.count} users, #{Task.count} tasks and #{Comment.count} comments created."
